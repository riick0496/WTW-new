 ...
 */
public class FragmentConsultarPeliculasAgenda extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_consultar_peliculas_de_agenda, container, false);
        return rootView;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        txtBuscar = (EditText) getView().findViewById(R.id.txtBuscarPelicula);
